...
(function ($) {
  ...
  $.fn.simpleColor = function (options) {
    ...
    // Option defaults
    options = $.extend({
      defaultColor: this.attr('data-defaultcolor') || '#FFF',
      border: this.attr('data-border') || '1px solid #000',
      cellWidth: this.attr('data-cellwidth') || 10,
      cellHeight: this.attr('data-cellHhight') || 10,
      cellMargin: this.attr('data-cellmargin') || 1,
      boxWidth: this.attr('data-boxwidth') || '115px',
      boxHeight: this.attr('data-boxheight') || '20px',
      columns: this.attr('data-columns') || 16,
      insert: this.attr('data-insert') || 'after',
      buttonClass: this.attr('data-buttonclass') || '',
      colors: this.attr('data-colors') || default_colors,
      displayColorCode: this.attr('data-displaycolorcode') || false,
      colorCodeAlign: this.attr('data-colorcodealign') || 'center',
      colorCodeColor: this.attr('data-colorcodecolor') || '#FFF',
      onSelect: null,
      onCellEnter: null,
      onClose: null,
      livePreview: true
