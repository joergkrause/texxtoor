...
(function() {
  $(document).ready(function () {
    ...
    var correct_header = function () {
      // JOERG: Use this to correct the position:fixed header in the container
      $('.page-header-with-buttons').width(($('#content-wrapper').width() - 16) + "px");
      $('#content-wrapper').height(($('.page-header-with-buttons').height() - 45) + "px");
    }

    $(window).on('resize', function () { correct_header(); });
