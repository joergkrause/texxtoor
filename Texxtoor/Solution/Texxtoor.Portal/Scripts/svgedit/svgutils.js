...
svgedit.utilities.buildCanvgCallback = function (callCanvg) {
  return svgedit.utilities.executeAfterLoads('canvg', [svgEditor.curConfig.scriptPath + 'canvg/rgbcolor.js', svgEditor.curConfig.scriptPath + 'canvg/canvg.js'], callCanvg);
};

svgedit.utilities.buildJSPDFCallback = function (callJSPDF) {
  return svgedit.utilities.executeAfterLoads('RGBColor', [svgEditor.curConfig.scriptPath + 'canvg/rgbcolor.js'], function () {
		var arr = [];
