		...
		var svgCanvas, urldata,
			...
			*/
			...
			defaultConfig = {
				...
				langPath: '/Scripts/svgedit/locale/',
				extPath: '/Scripts/svgedit/extensions/',
				scriptPath: '/Scripts/svgedit/',
				jGraduatePath: '/Scripts/svgedit/jgraduate/images/',
				// DOCUMENT PROPERTIES
			  ...
			  serverServiceloadSvg: '',
			  serverServicesaveSvg: '',
			  serverServicesaveImage: '',
			  serverServiceProjectLibrary: '',
			  projectId: 0,
			  resourceId: 0,
			  exportImageId: 0
	},
		...
		*/
		...
		editor.init = function () {
			...
			$.svgIcons(curConfig.imgPath + 'svg_edit_icons.svg', {
				...
				placement: {
					'#logo': 'logo', 
          // JK: some changes to reflect texxtoor ui style
					...
					'#tool_prefs_option > div': 'prefs_option',
...
'					<defs><linearGradient id="gradbox_"/></defs></svg>', 'text/xml');
		...
		//	}
          ...
          { sel: '#tool_exit', fn: exitEditor, evt: 'click' },
		...
		//			{sel: '#tools_ellipse_show', fn: clickEllipse, evt: 'click'},
              ...
              // JK: For ribbon support
							var menu = ($(sel).parents('#ribbon').length);
							...
							$(sel).each(function() {
								...
								if (menu) {
                  // JK: Ribbon Orb support
									$(this).find('span').text(t +' ['+key_str+']');
								} else {
...
//			});
  ...
  // JK: we can't do this because we load some tools after document.ready and this script needs to run after that
	$(svgEditor.init);
