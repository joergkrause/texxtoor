...
svgEditor.addExtension("imagelib", function() {'use strict';
  ...
  var img_libs = [
  {
    ...
    description: 'Standard library for image editor. This is a customizable library your administrator can extend to have custom drawings handy.'
  },
  {
    name: 'IAN Symbol Libraries',
    url: 'http://ian.umces.edu/symbols/catalog/svgedit/album_chooser.php',
    description: 'Free library of illustrations (free logon required). This is an external service not maintained by Augmented Content GmbH.'
  },
  {
    name: 'Openclipart',
    url: 'http://openclipart.org/svgedit',
    description: 'Share and Use Images. Over 50,000 Public Domain SVG Images and Growing. This is an external service not maintained by Augmented Content GmbH.'
  },
  {
    name: 'Current Project\'s Images',
    url: svgEditor.curConfig.serverServiceProjectLibrary + '&type=img',
    description: 'Your current project\'s content library. These are all plain images, but NOT any SVG drawings and even NO exports from SVG drawings.'
  },
  {
    name: 'Current Project\'s SVG Drawings',
    url: svgEditor.curConfig.serverServiceProjectLibrary + '&type=svg',
    description: 'All the SVG drawings in your current project\'s content library. These are SVG drawings you can work with. To use in content consider export as PNG.'
  }
	];
