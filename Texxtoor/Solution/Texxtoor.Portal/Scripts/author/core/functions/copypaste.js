...
var EDITOR = (function (my) {
  ...
  my.CopyPaste = (function () {

    /**
     * Retrieve the editable host in which the given range is contained.
     *
     * @param {WrappedRange} range
     * @return {$.<HTMLElement>|null} The editable host element, null if
    ...
    function getEditableAt(range) {
      ...
      return $container.length ? Core.getEditableHost($container) : null;
    }
