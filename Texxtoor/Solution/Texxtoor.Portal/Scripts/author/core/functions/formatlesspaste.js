/* formatlesspaste.js is part of Aloha Editor project http://aloha-editor.org
 *
...
var EDITOR = (function (my) {
  ...
  my.FormatlessPaste = (function () {
    ...
    my.bind('aloha-editable-destroyed', function ($event, data) {
    ...
    return {
      ...
      init: function () {
        var plugin = this;
        var config = Settings.config || Settings;

        applyConfiguration(plugin, parseConfiguration(config));

        my.bind('aloha-editable-activated', function ($event, data) {
