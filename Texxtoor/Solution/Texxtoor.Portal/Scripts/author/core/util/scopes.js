var EDITOR = (function (my) {
  ...
  my.Scopes = {
    ...
    createScope: function (scope, parentScopes) {
      ...
      this.scopes[scope] = parentScopes;
    }
  };
  ...
  my.bind('aloha-selection-changed-before', function () {
    scopeSetDuringSelectionChanged = false;
  });

  my.bind('aloha-selection-changed-after', function (event, range, originalEvent) {
