  ...
  my.Range = (function () {
    ...
    RangeObject.prototype = {
      ...
      getContainerParents: function (limit, fromEnd) {
        ...
        return $(selfAndParentsUntil(container, limit ? limit[0] : null));
      },
        ...
        if (this.isCollapsed()) {
          ...
          if (this.startContainer.nodeType === 1) {
            ...
            if (this.startOffset > 0 && this.startContainer.childNodes[this.startOffset - 1].nodeType === 1) {
              ...
              adjacentTextNode = my.Dom.searchAdjacentTextNode(this.startContainer, this.startOffset, true);
              if (adjacentTextNode) {
              ...
              adjacentTextNode = my.Dom.searchAdjacentTextNode(this.startContainer, this.startOffset, false);
              if (adjacentTextNode) {
                this.startContainer = this.endContainer = adjacentTextNode;
          ...
          if (this.startContainer.nodeType === 3 && this.startOffset === 0) {
            adjacentTextNode = my.Dom.searchAdjacentTextNode(this.startContainer.parentNode, Dom.getIndexInParent(this.startContainer), true);
            ...
            if (adjacentTextNode && $(adjacentTextNode).closest(my.Core.activeEditable.obj).length > 0) {
              this.startContainer = this.endContainer = adjacentTextNode;
              this.startOffset = this.endOffset = adjacentTextNode.data.length;
            }
          }
          ...
          if (this.startContainer.nodeType === 3 && this.startOffset === this.startContainer.data.length) {
            ...
            // yes, move into it
            adjacentTextNode = my.Dom.searchAdjacentTextNode(this.startContainer.parentNode, my.Dom.getIndexInParent(this.startContainer) + 1, false);
            if (adjacentTextNode) {
      ...
      recursiveGetRangeTree: function (currentObject) {
        ...
        jQueryCurrentObject.contents().each(function (index) {
          ...
          if (that.isCollapsed() && currentObject === that.startContainer && that.startOffset === index) {
            ...
            currentElements[childCount] = new RangeTree();
      ...
      recursiveGetText: function (tree) {
        ...
        $.each(tree, function () {
          if (this.type == 'full') {
            ...
            text += $(this.domobj).text();
          } else if (this.type == 'partial' && this.domobj.nodeType === 3) {
            // partially selected text node
            text += $(this.domobj).text().substring(this.startOffset, this.endOffset);
