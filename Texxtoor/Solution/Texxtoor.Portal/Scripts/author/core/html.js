...
var EDITOR = (function (my) {
  ...
  my.Html = (function () {
    ...
    my.Maps.fillKeys(blocksTagnameMap, BLOCKLEVEL_ELEMENTS, true);
    my.Maps.fillKeys(
      blocksTagnameMap,
      my.Arrays.map(BLOCKLEVEL_ELEMENTS, function (str) {
    ...
    function allowNestedParagraph(editable) {
      if (editable.obj[0] && my.Dom.allowsNesting(editable.obj[0], $("<p>")[0])) {
        return true;
      }
      return false;
    }
