...
var EDITOR = (function (my) {
  ...
  my.FormatlessHandler = (function () {

    /**
     * Remove unwanted formatting in the pasted element.
     *
     * @param {$.<HTMLElement>} $content Element to process.
    ...
    return {
       ...
       *
       * @param {string|$.<HTMLElement>} content The content to
       *                                              transform.
      ...
      isProppedParagraph: function (html) {
        my.contenthandler.isProppedParagraph(html);
      },

      wrapContent: function (content) {
        my.contenthandler.wrapContent(content);
      }
