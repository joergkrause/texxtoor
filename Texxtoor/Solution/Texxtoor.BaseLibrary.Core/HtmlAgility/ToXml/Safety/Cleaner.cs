...
namespace Texxtoor.BaseLibrary.Core.HtmlAgility.ToXml.Safety
{
    /// <summary>
    ...
    /// Rather than interacting directly with a Cleaner object, generally see the <code>Clean</code> methods in <see cref="Texxtoor.BaseLibrary.Core.HtmlAgility.ToXml"/>.
    /// </remarks>
    public class Cleaner
    {
        ...
        private ElementMeta CreateSafeElement(Element sourceEl)
        {
            ...
            foreach (Nodes.Attribute sourceAttr in sourceAttrs)
            {
            ...
            foreach (Nodes.Attribute item in enforcedAttrs)
            {
                destAttrs.Add(item);
            }
