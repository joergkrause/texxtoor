...
namespace Texxtoor.BaseLibrary.Core.HtmlAgility.ToXml.Nodes
{
    public class Element : Node
    {
        ...
        public string TagOriginalName()
        {
            return _tag.OriginalName;
            //return _tag.Name;
        }
        ...
        /// <see cref="Texxtoor.BaseLibrary.Core.HtmlAgility.ToXml.Select.Selector"/>
        /// <remarks>
        ...
        /// &lt;/ul&gt; 
        /// See the query syntax documentation in <see cref="Texxtoor.BaseLibrary.Core.HtmlAgility.ToXml.Select.Selector"/>
        /// </remarks>
