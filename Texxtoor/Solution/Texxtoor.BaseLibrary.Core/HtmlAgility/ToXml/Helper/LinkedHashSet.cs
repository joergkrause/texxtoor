...
namespace Texxtoor.BaseLibrary.Core.HtmlAgility.ToXml
{
    internal class LinkedHashSet<T> : ICollection<T>, IEnumerable<T>, IEnumerable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the Texxtoor.BaseLibrary.Core.HtmlAgility.ToXml.LinkedHashSet<T> 
        ...
        /// <summary>
        /// Initializes a new instance of the Texxtoor.BaseLibrary.Core.HtmlAgility.ToXml.LinkedHashSet<T> class
        ...
        /// <summary>
        /// Removes all elements from the Texxtoor.BaseLibrary.Core.HtmlAgility.ToXml.LinkedHashSet<T>.
        /// </summary>
        public void Clear()
        {
            _hashSet.Clear();
        ...
        /// </summary>
        /// <param name="item">The element to locate in the Texxtoor.BaseLibrary.Core.HtmlAgility.ToXml.LinkedHashSet<T> object.</param>
        ...
        /// <summary>
        /// Copies the elements of a Texxtoor.BaseLibrary.Core.HtmlAgility.ToXml.LinkedHashSet<T> object to 
        ...
        /// <summary>
        /// Removes the first occurrence of a specific object from the Texxtoor.BaseLibrary.Core.HtmlAgility.ToXml.LinkedHashSet<T>.
        /// </summary>
        ...
        /// returns false if item was not found in the Texxtoor.BaseLibrary.Core.HtmlAgility.ToXml.LinkedHashSet<T>.
        /// </returns>
        ...
        /// <summary>
        /// Sets the capacity of a Texxtoor.BaseLibrary.Core.HtmlAgility.ToXml.LinkedHashSet<T> object to the
