...
namespace Texxtoor.BaseLibrary.Core.HtmlAgility.ToXml.Parse
{
    /// <summary>
                ...
                switch (t.Type)
                {
                    ...
                    case Token.TokenType.StartTag:
                        ...
                        if (name.Equals("html"))
                        {
                            ...
                            foreach (Nodes.Attribute attribute in startTag.Attributes)
                            {
                        ...
                        else if (name.Equals("isindex"))
                        {
                            ...
                            foreach (Texxtoor.BaseLibrary.Core.HtmlAgility.ToXml.Nodes.Attribute attr in startTag.Attributes)
                            {
