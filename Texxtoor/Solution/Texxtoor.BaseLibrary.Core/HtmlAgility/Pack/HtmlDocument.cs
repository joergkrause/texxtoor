...
namespace Texxtoor.BaseLibrary.Core.HtmlAgility.Pack {
  ...
  public class HtmlDocument : IXPathNavigable {
    ...
    /// <summary>
    /// Defines if output must conform to XHTML, instead of HTML.
    /// </summary>
    public bool OptionOutputAsXhtml;
    ...
    /// <summary>
    /// What sort of DOCTYPE We shall prepend the document with.
    /// </summary>
    public string OptionXhtmlDeclaration { get; set; }
  }
}