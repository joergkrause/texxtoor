...
namespace Texxtoor.BaseLibrary.EPub.Model {
  ...
  public class OpfPackage : EntityBase {
    ...
    internal static OpfPackage CreatePackage(XElement element, ZipArchive gz, string opsFolder, out string ncx) {
    ...
    internal static XElement CreateXElement(OpfPackage package) {
      if (package.Version == null) {
        package.Version =
          typeof (OpfPackage).GetProperty("Version")
      ...
      if (package.Identifier == null) {
        package.Identifier =
          typeof(OpfPackage).GetProperty("Identifier")
                             .GetCustomAttributes(typeof(DefaultValueAttribute), true)
                             .OfType<DefaultValueAttribute>()
                             .Single()
                             .Value.ToString();
      }
      var xe = new XElement(OpfNameSpace + "package",
    ...
    /// </summary>
    public virtual Binding Bindings { get; set; }

    public virtual Spine Spine { get; set; }
