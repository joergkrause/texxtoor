...
namespace Texxtoor.Models.Attributes {
  ...
  public class SnippetElementAttribute : Attribute {

    public SnippetElementAttribute(string pattern, params string[] properties) {
    ...
    internal string BuildHtml(Snippet snippet, IDictionary<string, NumberingSchema> numbering) {
          ...
          if (t == "Section") {
            ...
            if (numbering.ContainsKey(t + d)) {
              ...
              if (o > 1) {
                ...
                ((Section)snippet).ParentNumbering = String.Format("{0}", numbering[s].Major, pn);
              }
