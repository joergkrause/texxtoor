    ...
    $.fn.Ribbon = function (ribbonSettings) {
        ...
        function SetupMenu(settings) {
            ...
            $('.ribbon-list div').on('click', function (e) {
                ...
                var elwidth = $(this).children('ul').width() < elwidth ? elwidth : $(this).children('ul li').width();
        ...
        if (!settings.backStage) {
            $('.orb li:first ul:first').append('<img src="' + settings.baseUrl + 'ribbon/themes/' + settings.theme + '/images/menu_bottom.png" style="margin-left: -10px; margin-bottom: -22px;" />');
            $('.orb li:first ul:first').prepend('<img src="' + settings.baseUrl + 'ribbon/themes/' + settings.theme + '/images/menu_top.png" style="margin-left: -10px; margin-top: -22px;" />');
        }
        ...
        function ShowSubMenu(e) {
            ...
            if(isClosed)author.jscroll.resize();
            isClosed = false;
        }
