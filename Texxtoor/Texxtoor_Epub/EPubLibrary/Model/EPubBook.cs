...
namespace Texxtoor.BaseLibrary.EPub.Model {
  ...
  public class EpubBook : EntityBase {
    ...
    /// </summary>
    public Container ContainerData { get; set; }
    ...
    /// </summary>
    public OpfPackage PackageData { get; set; }

    public Navigation NavigationData { get; set; }
    ...
    /// </summary>
    /// <returns></returns>
    public IEnumerable<Image> GetImageFiles() {
      return PackageData.Manifest.Items.OfType<Image>();
    }
