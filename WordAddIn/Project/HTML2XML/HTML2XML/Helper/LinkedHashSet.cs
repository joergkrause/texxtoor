...
namespace HTML2XML
{
    internal class LinkedHashSet<T> : ICollection<T>, IEnumerable<T>, IEnumerable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the HTML2XML.LinkedHashSet<T> 
        ...
        /// <summary>
        /// Initializes a new instance of the HTML2XML.LinkedHashSet<T> class
        ...
        /// <summary>
        /// Removes all elements from the HTML2XML.LinkedHashSet<T>.
        /// </summary>
        public void Clear()
        {
            _hashSet.Clear();
        ...
        /// </summary>
        /// <param name="item">The element to locate in the HTML2XML.LinkedHashSet<T> object.</param>
        ...
        /// <summary>
        /// Copies the elements of a HTML2XML.LinkedHashSet<T> object to 
        ...
        /// <summary>
        /// Removes the first occurrence of a specific object from the HTML2XML.LinkedHashSet<T>.
        /// </summary>
        ...
        /// returns false if item was not found in the HTML2XML.LinkedHashSet<T>.
        /// </returns>
        ...
        /// <summary>
        /// Sets the capacity of a HTML2XML.LinkedHashSet<T> object to the
