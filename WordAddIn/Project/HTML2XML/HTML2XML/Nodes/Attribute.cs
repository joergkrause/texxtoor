...
namespace HTML2XML.Nodes
{
    ...
    public class Attribute : IEquatable<Attribute>, ICloneable
    {
        ...
        public void HtmlOriginal(StringBuilder accum, OutputSettings output)
        {
            accum.Append(_keyOrigin)
                .Append("=\"")
                .Append(Entities.Escape(Value, output))
                .Append("\"");
        }
