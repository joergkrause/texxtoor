...
namespace HTML2XML.Nodes
{
    ...
    public class Entities
    {
        ...
        static Entities()
        {
            ...
            _base = LoadEntities("HTML2XML.Nodes.entities-base.txt");
            _baseByVal = ToCharacterKey("HTML2XML.Nodes.entities-base.txt");
            _full = LoadEntities("HTML2XML.Nodes.entities-full.txt");
            _fullByVal = ToCharacterKey("HTML2XML.Nodes.entities-full.txt");
